...
# ./transHISAT2.py --1 ~/JHU/transcriptome/hisatTrans2Genome/errorData/me_mi/reads_1/sample_01_1.fasta --2 ~/JHU/transcriptome/hisatTrans2Genome/errorData/me_mi/reads_1/sample_01_2.fasta --gff ~/JHU/transcriptome/hisatTrans2Genome/errorData/me_mi/data/ann.gff --ref ~/genomicData/hg38/hg38_p8.fa -o ./test --tmp ./tmp
