...
private:
    ...
    void process_status(bam1_t *mate,bam1_t *curAl,bool &check_mate,bam_hdr_t* al_hdr);
    void _process_disc(bam1_t *curAl,bam1_t* mate,bam_hdr_t* al_hdr);
    void process_disc(bam1_t *curAl,bam1_t *mate,bam_hdr_t* al_hdr);
    void _process_pair(bam1_t *curAl,bam1_t* mate,bam_hdr_t* al_hdr);
    void process_pair(bam1_t *curAl,bam1_t *mate,bam_hdr_t* al_hdr);
    void process_single(bam1_t *curAl,bam_hdr_t* al_hdr);
    void process_single_mate(bam1_t *aligned, bam1_t *unaligned,bam_hdr_t* al_hdr);
